...
from tests.stubs import StubSchedulingActor, cb_identity, cb_times2

from doreisa.simulation_node import Client
from tests.utils import ray_cluster
...
def test_actor_dies_and_client_recovers(ray_cluster):
    ...
    c1 = Client(_node_id=fake_node_id, scheduling_actor_cls=StubSchedulingActor)
