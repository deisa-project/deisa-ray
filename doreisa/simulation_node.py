# FIX: Now, the head and client are totally decoupled. We are missing that the head should
# know how many scheduling actors are available (this was the old logic)
